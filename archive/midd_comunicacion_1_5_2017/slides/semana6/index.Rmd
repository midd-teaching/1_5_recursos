...
rmarkdown::render("./slides/semana6/index.Rmd")
xaringan::inf_mr('./slides/semana6/index.Rmd')
xaringan::inf_mr()
```
...
- El uso de varios elementos visuales que pueden facilitar la comprensión de las instrucciones y es apropiado para este tipo de actividad. 
